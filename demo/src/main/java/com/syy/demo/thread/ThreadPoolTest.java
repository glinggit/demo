...
public class ThreadPoolTest {
    // 固定大小的线程池：
    // 初始化一个指定线程数的线程池，其中corePoolSize == maximumPoolSize，使用LinkedBlockingQuene作为阻塞队列，
    ...
    // private static ExecutorService executor3_ = new
    ...
    // private static ExecutorService executor4_ = new ThreadPoolExecutor(1,
    ...
    public static void main(String[] args) {
       ...
       // executor_.execute(() -> System.out.println("hhh"));
